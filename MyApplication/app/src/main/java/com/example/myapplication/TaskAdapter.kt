...
*/
internal class TaskAdapter(data: OrderedRealmCollection<TaskChange>) : RealmRecyclerViewAdapter<TaskChange, TaskAdapter.TaskViewHolder?>(data, true) {
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        val obj: TaskChange? = getItem(position)
        holder.data = obj
    ...
    private fun changeStatus(status: TaskStatus, _id: ObjectId?) {
        ...
        bgRealm!!.executeTransaction {
            ...
            val item = it.where<TaskChange>().equalTo("_id", _id).findFirst()
    ...
    private fun removeAt(id: ObjectId) {
        ...
        bgRealm!!.executeTransaction {
            ...
            val item = it.where<TaskChange>().equalTo("_id", id).findFirst()
